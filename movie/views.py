...
def home(request):
    ...
    #return render(request, 'home.html', {'name':'Valentina Giraldo'})
...
'''Este código ubicado aquí abajo es el del gráfico de películas por año'''
...
'''Este código ubicado aquí abajo es el del gráfico de películas por género'''
# Versión más eficiente
def statistics_genre_view(request):
    ...
    # Crear un diccionario para alamcenar la cantidad de películas por género
